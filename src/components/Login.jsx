              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    required
                    className="appearance-none rounded-md block w-full px-3 py-2 border dark:border-dark-border border-border bg-secondaryBackground dark:bg-dark-secondaryBackground text-primaryText dark:text-dark-primaryText placeholder-secondaryText dark:placeholder--secondaryText focus:outline-none focus:ring-primaryAccent focus:border-primaryAccent sm:text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    required
                    className="appearance-none rounded-md block w-full px-3 py-2 border border-border dark:border-dark-border bg-secondaryBackground dark:bg-dark-secondaryBackground text-primaryText dark:text-dark-primaryText placeholder-secondaryText focus:outline-none focus:ring-primaryAccent focus:border-primaryAccent sm:text-sm"
                  />
                </div>
              </div>
              <div>
